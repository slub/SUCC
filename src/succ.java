...
public class succ {
    ...
    public static void main (String[] args) {
        ...
        // main decision based on function value
        switch (cmdParams.getOrDefault("function", "help")) {
            case "mabd2d": {        // mab disk -> mab disk
            ...
            case "mabt2dlist": {        // multiple (mab tape -> mab disk)
        ...
        // showing timing stats for actions
        dumpActionStats();

        // stop and show time for whil program
    ...
    // starting point for processing MAB TAPE files
    ...
    // starting point for processing MAB DISK files
    ...
    // starting transforming whole MAB file
    ...
    // starting transforming one MAB record
